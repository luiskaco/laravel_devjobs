<ul class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
    @foreach ($vacantes as $vacante)
         <li class="p-10 border border-gray-300 bg-white shadow ">
             <h2 class="text-2xl font-bold text-green-90">{{$vacante->titulo}}</h2>
             ...
             <a
                 class="bg-green-400 hover:bg-green-500 text-gray-100 mt-2 px-4 py-2 inline-block rounded font-bold text-sm"
