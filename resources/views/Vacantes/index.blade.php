            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                ...
                <estado-vacante
                    ...
                    path-vacante="{{route('vacante.estado', ['vacante' => $vacante->id])}}"
                ></estado-vacante>

                    {{-- Nota: Siempre se envie un props con guion medio. La propiedad se escribe sin el guion y con la primera en mayusculas --}}
              ...
              <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500">
                  ...
                  > {{ $vacante->candidato->count()}}  Candidatos</a>
              </td>
